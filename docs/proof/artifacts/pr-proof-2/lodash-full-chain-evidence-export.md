...
- Type: dependency-exposure Â· status: observed
- Source: cli (`c:\tmp\opensoyce-proof2\deps.json`)
- First seen: 2026-06-11T04:59:41.3636+00:00 Â· last seen: 2026-06-11T04:59:41.3636+00:00 Â· seen count: 1
- Trust boundary: `{"manifest_kind":"explicit-json","package_manager":"npm"}`

## 3. Vulnerability / risk context

Severity is reproduced in the sourceâ€™s vocabulary; OpenSoyce does not branch on it.

- `GHSA-xxjr-mmjv-4gpg` - source: osv Â· match basis: osv-version-query Â· severity (as reported by source): medium
  ...
  - first seen 2026-06-11T05:00:44.516298+00:00 Â· last seen 2026-06-11T05:00:44.516298+00:00 Â· seen x1 Â· record `97d40dd0-004c-4ab9-8e9e-595739531cfa`
- `GHSA-r5fr-rjxr-66jc` - source: osv Â· match basis: osv-version-query Â· severity (as reported by source): high
  ...
  - first seen 2026-06-11T05:00:44.457254+00:00 Â· last seen 2026-06-11T05:00:44.457254+00:00 Â· seen x1 Â· record `249d219d-1e97-47c5-b8d1-742f02a87bf3`
- `GHSA-f23m-r3pf-42rh` - source: osv Â· match basis: osv-version-query Â· severity (as reported by source): medium
  ...
  - first seen 2026-06-11T05:00:44.397071+00:00 Â· last seen 2026-06-11T05:00:44.397071+00:00 Â· seen x1 Â· record `35aa593b-ab75-4f7e-897a-0500747dd19b`
- `GHSA-35jh-r3h4-6jhm` - source: osv Â· match basis: osv-version-query Â· severity (as reported by source): high
  ...
  - first seen 2026-06-11T05:00:44.33235+00:00 Â· last seen 2026-06-11T05:00:44.33235+00:00 Â· seen x1 Â· record `48fdc627-481d-4cf8-9b1f-792fab73faed`
- `GHSA-29mw-wpgm-hmr9` - source: osv Â· match basis: osv-version-query Â· severity (as reported by source): medium
  ...
  - first seen 2026-06-11T05:00:44.261696+00:00 Â· last seen 2026-06-11T05:00:44.261696+00:00 Â· seen x1 Â· record `0ccb925a-e403-47f3-8632-3a2d408bc497`

## 4. Remediation question

- Question `da53bf51-96c7-4b39-a7aa-9930926582d7` - kind: vulnerability_review Â· about: GHSA-35jh-r3h4-6jhm Â· status: answered
...
- Exception `888aae0f-eb07-4eec-a16a-a093294b8c76` - package lodash Â· proposed transition: BLOCK â†’ WARN Â· current state: expired
...
- System observation `1f381ff9-325d-403a-991b-6092af865571` (exception_expired_from_exposure) - actor: system
  - expired at 2026-06-11T05:04:17.099+00:00 Â· observed by the reaper at 2026-06-11T06:36:32.675Z
...
- Resolution `08efc01d-4961-4e95-9003-19750b37ecff` on exception `888aae0f-eb07-4eec-a16a-a093294b8c76` - direction: `remediation_required`
  ...
  - reason: PR-PROOF-2 production dogfood chain. lodash@4.17.20 was observed through the real CLI, OSV context recorded five advisories, the remediation question was answered by @freewho99 with propose_exception, and exception 888aae0f was approved BLOCKâ†’WARN with a short expiry. The expiry
...
- 2026-06-11T05:01:48.747852+00:00 - `exception_proposed_from_exposure` Â· actor: @freewho99 Â· exception `888aae0f-eb07-4eec-a16a-a093294b8c76` Â· event `1fc05bdd-9cd2-4318-9b01-3789eedb4189`
- 2026-06-11T05:01:49.026736+00:00 - `exception_approved_from_exposure` Â· actor: @freewho99 Â· exception `888aae0f-eb07-4eec-a16a-a093294b8c76` Â· event `0691f330-9f9a-49ae-ab87-68ab43913571`
- 2026-06-11T06:36:35.04614+00:00 - `exception_expired_from_exposure` Â· actor: system Â· exception `888aae0f-eb07-4eec-a16a-a093294b8c76` Â· event `1f381ff9-325d-403a-991b-6092af865571`

Vault timeline events:

- 2026-06-11T05:01:48.687387+00:00 - `exception_proposed` Â· Proposed exception on lodash: BLOCK -> WARN. Reason: Short-window risk acceptance for lodash 4.17.20 while the 4.17.21 upgrade lands (per answered remediation question da53bf51).. Â· emitted by @freewho99 Â· event `a3a0bab0-538a-40d6-a0bd-664f9254c90e`
- 2026-06-11T05:01:48.975976+00:00 - `exception_approved` Â· Approved exception on lodash: BLOCK -> WARN until 2026-06-11T05:04:17Z. Reason: Short-window risk acceptance for lodash 4.17.20 while the 4.17.21 upgrade lands (per answered remediation question da53bf51).. Â· emitted by @freewho99 Â· event `6422c83d-dcad-4325-9515-9c8c3de4db1d`
- 2026-06-11T06:36:34.896759+00:00 - `exception_expired` Â· Exception expired on lodash at scheduled 2026-06-11T05:04:17Z. Â· emitted by system Â· event `b6a72b57-9f69-40e1-a8bd-07261e7b2336`
