export default async function handler(req, res) {
  ...
  try {
    ...
    res.status(200).json({
      name: repoData.name, owner: repoData.owner.login, description: repoData.description,
      stars: repoData.stargazers_count, forks: repoData.forks_count, lastScanned: 'Just now',
      techStack: repoData.topics || [], license: repoData.license?.spdx_id || 'No License',
      score: {
        overall: total,
