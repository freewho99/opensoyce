...
const REQUIRED_TABLES = [
  ...
  'evidence_verification_checks', 'agent_evidence_drafts',
];
...
async function layer2Runtime() {
  ...
  const probes = [
    ...
    ['GET /api/vault/workspaces/__guard__/agent-drafts', await probe('/api/vault/workspaces/__guard__/agent-drafts')],
