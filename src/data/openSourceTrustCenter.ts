import {
  ...
  OPEN_SOURCE_TRUST_CENTER_PHASE_3_LAUNCH_BANNED_SUBSTRINGS as JS_PHASE_3_BANNED,
  OPEN_SOURCE_TRUST_CENTER_PHASE_4_DISTRIBUTION_BANNED_SUBSTRINGS as JS_PHASE_4_BANNED,
  OPEN_SOURCE_TRUST_CENTER_PHASE_4_WORD_BOUNDARY_BANNED as JS_PHASE_4_WB_BANNED,
...
export const OPEN_SOURCE_TRUST_CENTER_PHASE_3_LAUNCH_BANNED_SUBSTRINGS = JS_PHASE_3_BANNED as readonly string[];
export const OPEN_SOURCE_TRUST_CENTER_PHASE_4_DISTRIBUTION_BANNED_SUBSTRINGS = JS_PHASE_4_BANNED as readonly string[];
export const OPEN_SOURCE_TRUST_CENTER_PHASE_4_WORD_BOUNDARY_BANNED = JS_PHASE_4_WB_BANNED as readonly string[];
